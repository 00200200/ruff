...
/// Records how inference evaluated a name load when its file has recording enabled.
///
...
///
/// Returns an empty map without running inference if recording is disabled for the file.
